GCC_BIN =  /usr/bin/X11/
PROJECT = main
OBJECTS = system_LPC17xx.o startup_LPC17xx.o delay.o uart.o testaT_nrf24.o digital.o spi.o nrf24.o
SYS_OBJECTS = 
...
clean:
	rm -f *~ $(PROJECT).hex $(PROJECT).bin $(PROJECT).elf $(addprefix $(BUILD_DIR), $(OBJECTS)) $(PROJECT).map
	rmdir $(BUILD_DIR)
...
.cpp.o:
	mkdir -p $(BUILD_DIR)
	$(CPP) $(CC_FLAGS) $(CC_SYMBOLS) -std=gnu++11 $(INCLUDE_PATHS) -o $(addprefix $(BUILD_DIR), $@) $<
